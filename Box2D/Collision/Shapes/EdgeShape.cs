...
namespace Box2D
{
    public class EdgeShape : Shape
    {
                            ...
                            ref Transform transform, int childIndex)
        {
            ...
            Vec2 p1 = MathUtils.MultiplyT(ref transform.R, input.p1 - transform.Position);
            Vec2 p2 = MathUtils.MultiplyT(ref transform.R, input.p2 - transform.Position);
            Vec2 d = p2 - p1;
        ...
        {
            aabb = new AABB();
            Vec2 v1 = MathUtils.Multiply(ref transform, _vertex1);
            Vec2 v2 = MathUtils.Multiply(ref transform, _vertex2);

            Vec2 lower = Vec2.Min(v1, v2);
            Vec2 upper = Vec2.Max(v1, v2);
        ...
        public Vec2 _vertex1, _vertex2;

        /// Optional adjacent vertices. These are used for smooth collision.
        public Vec2 _vertex0, _vertex3;
