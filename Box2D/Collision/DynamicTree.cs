...
namespace Box2D
{
    ...
    public class DynamicTree
    {
        ...
        public int CreateProxy(ref AABB aabb, object userData)
        {
            ...
            // Fatten the aabb.
            Vec2 r = new Vec2(Settings.b2_aabbExtension, Settings.b2_aabbExtension);
        ...
        public bool MoveProxy(int proxyId, ref AABB aabb, Vec2 displacement)
        {
            ...
            Vec2 d = Settings.b2_aabbMultiplier * displacement;
        ...
        internal void RayCast(RayCastCallbackInternal callback, ref RayCastInput input) 
        {
            ...
            Vec2 v = MathUtils.Cross(1.0f, r);
            Vec2 abs_v = MathUtils.Abs(v);
        ...
        private void InsertLeaf(int leaf)
        {
            ...
            Vec2 leafCenter = leafAABB.GetCenter();
            int sibling = _root;
            while (_nodes[sibling].IsLeaf() == false)
            {
                ...
                Vec2 delta1 = Math.Abs(_nodes[child1].aabb.GetCenter() - leafCenter);
                Vec2 delta2 = Math.Abs(_nodes[child2].aabb.GetCenter() - leafCenter);
