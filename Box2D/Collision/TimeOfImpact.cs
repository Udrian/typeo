    ...
    public struct SeparationFunction
    {
            ...
            float t1)
        {
            ...
            if (count == 1)
            {
                ...
                Vec2 pointA = MathUtils.Multiply(ref xfA, localPointA);
                Vec2 pointB = MathUtils.Multiply(ref xfB, localPointB);
                _axis = pointB - pointA;
                _axis.Normalize();
                return;
            }
            else if (cache.indexA[0] == cache.indexA[1])
            {
                ...
                _axis.Normalize();
                Vec2 normal = MathUtils.Multiply(ref xfB.R, _axis);

                _localPoint = 0.5f * (localPointB1 + localPointB2);
                Vec2 pointB = MathUtils.Multiply(ref xfB, _localPoint);
            ...
            else
            {
                ...
                _axis.Normalize();
                Vec2 normal = MathUtils.Multiply(ref xfA.R, _axis);

                _localPoint = 0.5f * (localPointA1 + localPointA2);
                Vec2 pointA = MathUtils.Multiply(ref xfA, _localPoint);
        ...
        public float FindMinSeparation(out int indexA, out int indexB, float t)
        {
            ...
            switch (_type)
            {
                ...
                {
                    Vec2 axisA = MathUtils.MultiplyT(ref xfA.R,  _axis);
                    Vec2 axisB = MathUtils.MultiplyT(ref xfB.R, -_axis);

                    indexA = _proxyA.GetSupport(axisA);
                    indexB = _proxyB.GetSupport(axisB);

                    Vec2 localPointA = _proxyA.GetVertex(indexA);
                    Vec2 localPointB = _proxyB.GetVertex(indexB);
                ...
                case SeparationFunctionType.FaceA:
                {
                    ...
                    Vec2 axisB = MathUtils.MultiplyT(ref xfB.R, -normal);
                ...
                case SeparationFunctionType.FaceB:
                {
                    ...
                    Vec2 axisA = MathUtils.MultiplyT(ref xfA.R, -normal);
