...
namespace Box2D
{
    ...
    class Island
    {
        ...
        public void Solve(ref TimeStep step, Vec2 gravity, bool allowSleep)
        {
            ...
            for (int i = 0; i < _bodyCount; ++i)
            {
                ...
                b._linearVelocity += step.dt * ((gravity * b.GravityScale) + b._invMass * b._force);
                Debug.Assert(!(float.IsNaN(b._linearVelocity.X) || float.IsNaN(b._linearVelocity.Y)), "LinearVelocity is NaN");
            ...
            for (int i = 0; i < _bodyCount; ++i)
            {
                ...
                if (Vec2.Dot(translation, translation) > Settings.b2_maxTranslationSquared)
                {
