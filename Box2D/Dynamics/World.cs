            ...
            if ((flags & DebugDrawFlags.Pair) == DebugDrawFlags.Pair)
            {
                ...
                for (Contact c = _contactManager._contactList; c != null; c = c.GetNext())
                {
                  /*  
                   ...
                   Vec2 cA = aabbA.GetCenter();
                   Vec2 cB = aabbB.GetCenter();
                ...
                for (Body b = _bodyList; b != null; b = b.GetNext())
                {
                    ...
                    for (Fixture f = b.GetFixtureList(); f != null; f = f.GetNext())
                    {
                        for (int i = 0; i < f._proxyCount; ++i)
                        {
                            ...
                            FixedArray8<Vec2> vs = new FixedArray8<Vec2>();
            ...
            case ShapeType.Circle:
                {
                    ...
                    Vec2 center = MathUtils.Multiply(ref xf, circle._p);
            ...
            case ShapeType.Polygon:
                {
                    ...
                    FixedArray8<Vec2> vertices = new FixedArray8<Vec2>();
            ...
            case ShapeType.Edge:
                {
                    ...
                    Vec2 v1 = MathUtils.Multiply(ref xf, edge._vertex1);
                    Vec2 v2 = MathUtils.Multiply(ref xf, edge._vertex2);
            ...
            case ShapeType.Loop:
                {
                    ...
                    Vec2 v1 = MathUtils.Multiply(ref xf, loop._vertices[count - 1]);
                    for (int i = 0; i < count; ++i)
                    {
                        Vec2 v2 = MathUtils.Multiply(ref xf, loop._vertices[i]);
                        DebugDraw.DrawSegment(v1, v2, color);
                        v1 = v2;
                    }
                }
