...
namespace Box2D
{
    ...
    {
        public FixedArray2<Vec2> localPoints;
            ...
            case ManifoldType.Circles:
                {
                    ...
                    Vec2 pointB = cc.bodyB.GetWorldPoint(cc.localPoints[0]);
                    ...
                    separation = Vec2.Dot(pointB - pointA, normal) - cc.radius;
                }
                break;
            ...
            case ManifoldType.FaceA:
                {
                    ...
                    Vec2 clipPoint = cc.bodyB.GetWorldPoint(cc.localPoints[index]);
                    separation = Vec2.Dot(clipPoint - planePoint, normal) - cc.radius;
                    point = clipPoint;
                }
                break;
            ...
            case ManifoldType.FaceB:
                {
                    ...
                    Vec2 clipPoint = cc.bodyA.GetWorldPoint(cc.localPoints[index]);
                    separation = Vec2.Dot(clipPoint - planePoint, normal) - cc.radius;
                    point = clipPoint;
