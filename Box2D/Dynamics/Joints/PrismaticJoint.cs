...
namespace Box2D
{
    ...
    public class PrismaticJoint : Joint
    {
        ...
        public float GetJointSpeed()
        {
            ...
            Vec2 r1 = MathUtils.Multiply(ref xf1.R, _localAnchor1 - b1.GetLocalCenter());
            Vec2 r2 = MathUtils.Multiply(ref xf2.R, _localAnchor2 - b2.GetLocalCenter());
            ...
            float speed = Vec2.Dot(d, MathUtils.Cross(w1, axis)) + Vec2.Dot(axis, v2 + MathUtils.Cross(w2, r2) - v1 - MathUtils.Cross(w1, r1));
            return speed;
        }
        ...
        internal override void InitVelocityConstraints(ref TimeStep step)
        {
            ...
            Vec2 r1 = MathUtils.Multiply(ref xf1.R, _localAnchor1 - _localCenterA);
            Vec2 r2 = MathUtils.Multiply(ref xf2.R, _localAnchor2 - _localCenterB);
            ...
            // Prismatic constraint.
            {
                ...
                _K.col1 = new Vec3(k11, k12, k13);
                _K.col2 = new Vec3(k12, k22, k23);
                _K.col3 = new Vec3(k13, k23, k33);
            }
        ...
        internal override void SolveVelocityConstraints(ref TimeStep step)
        {
            ...
            Vec2 Cdot1 = new Vec2(Vec2.Dot(_perp, v2 - v1) + _s2 * w2 - _s1 * w1, w2 - w1);
        ...
        internal override bool SolvePositionConstraints(float baumgarte)
        {
            ...
            Vec2 r1 = MathUtils.Multiply(ref R1, _localAnchor1 - _localCenterA);
            Vec2 r2 = MathUtils.Multiply(ref R2, _localAnchor2 - _localCenterB);
            Vec2 d = c2 + r2 - c1 - r1;
            ...
            Vec3 impulse;
            Vec2 C1 = new Vec2(Vec2.Dot(_perp, d), a2 - a1 - _refAngle);
            ...
            else
            {
                ...
                _K.col1 = new Vec3(k11, k12, 0.0f);
                _K.col2 = new Vec3(k12, k22, 0.0f);
