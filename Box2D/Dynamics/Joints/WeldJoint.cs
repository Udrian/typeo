...
namespace Box2D
{
    ...
    public class WeldJoint : Joint
    {
        ...
        {
            Vec2 F = (inv_dt * new Vec2(_impulse.X, _impulse.Y));
            return F;
        }
        ...
        internal override void InitVelocityConstraints(ref TimeStep step)
        {
            ...
            Vec2 rA = MathUtils.Multiply(ref xfA.R, _localAnchorA - bA.GetLocalCenter());
            Vec2 rB = MathUtils.Multiply(ref xfB.R, _localAnchorB - bB.GetLocalCenter());
        ...
        internal override void SolveVelocityConstraints(ref TimeStep step)
        {
            ...
            Vec2 Cdot1 = vB + MathUtils.Cross(wB, rB) - vA - MathUtils.Cross(wA, rA);
            float Cdot2 = wB - wA;
