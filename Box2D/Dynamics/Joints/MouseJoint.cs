...
public class MouseJoint : Joint
{
    ...
    internal override void InitVelocityConstraints(ref TimeStep step)
    {
        ...
        Vec2 r = MathUtils.Multiply(ref xf1.R, _localAnchor - b.GetLocalCenter());
        ...
        Mat22 K1 = new Mat22(new Vec2(invMass, 0.0f), new Vec2(0.0f, invMass));
        Mat22 K2 = new Mat22(new Vec2(invI * r.Y * r.Y, -invI * r.X * r.Y), new Vec2(-invI * r.X * r.Y, invI * r.X * r.X));
    ...
    internal override void SolveVelocityConstraints(ref TimeStep step)
    {
        ...
        // Cdot = v + cross(w, r)
        Vec2 Cdot = b._linearVelocity + MathUtils.Cross(b._angularVelocity, r);
        Vec2 impulse = MathUtils.Multiply(ref _mass, -(Cdot + _beta * _C + _gamma * _impulse));
