...
namespace Box2D
{
    ...
    public class FrictionJoint : Joint
    {
        ...
        internal override void InitVelocityConstraints(ref TimeStep step)
        {
            ...
            Vec2 rA = MathUtils.Multiply(ref xfA.R, _localAnchor1 - bA.GetLocalCenter());
            Vec2 rB = MathUtils.Multiply(ref xfB.R, _localAnchor2 - bB.GetLocalCenter());
        ...
        internal override void SolveVelocityConstraints(ref TimeStep step)
        {
            ...
            {
                Vec2 Cdot = vB + MathUtils.Cross(wB, rB) - vA - MathUtils.Cross(wA, rA);

                Vec2 impulse = -MathUtils.Multiply(ref _linearMass, Cdot);
