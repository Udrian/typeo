...
namespace Box2D
{
    ...
    public class MaxDistanceJointDef : JointDef
    {
        ...
        public void Initialize(Body b1, Body b2,
                        Vec2 anchor1, Vec2 anchor2, float maxlength)
        {
            bodyA = b1;
            bodyB = b2;
    ...
    public class MaxDistanceJoint : Joint
    {
        ...
        internal override void SolveVelocityConstraints(ref TimeStep step)
        {
            ...
            Vec2 v1 = b1._linearVelocity + MathUtils.Cross(b1._angularVelocity, r1);
            Vec2 v2 = b2._linearVelocity + MathUtils.Cross(b2._angularVelocity, r2);
