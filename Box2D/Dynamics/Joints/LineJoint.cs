    ...
    public class LineJoint : Joint
    {
        ...
        internal override void InitVelocityConstraints(ref TimeStep step)
        {
            ...
            // Prismatic constraint.
            {
                ...
                _K.col1 = new Vec2(k11, k12);
                _K.col2 = new Vec2(k12, k22);
            }
        ...
        internal Vec2 _localAnchor1;
        internal Vec2 _localAnchor2;
        internal Vec2 _localXAxis1;
        internal Vec2 _localYAxis1;

        internal Vec2 _axis, _perp;
        internal float _s1, _s2;
        internal float _a1, _a2;

        internal Mat22 _K;
        internal Vec2 _impulse;
