    ...
    public class RevoluteJoint : Joint
    {
        ...
        internal override void SolveVelocityConstraints(ref TimeStep step)
        {
            ...
            if (_enableLimit && _limitState != LimitState.Inactive)
            {
                ...
                Vec2 Cdot1 = v2 + MathUtils.Cross(w2, r2) - v1 - MathUtils.Cross(w1, r1);
                float Cdot2 = w2 - w1;
            ...
            else
            {
                ...
                // Solve point-to-point constraint
                Vec2 Cdot = v2 + MathUtils.Cross(w2, r2) - v1 - MathUtils.Cross(w1, r1);
        ...
        internal override bool SolvePositionConstraints(float baumgarte)
        {
            ...
            // Solve point-to-point constraint.
            {
                ...
                Mat22 K1 = new Mat22(new Vec2(invMass1 + invMass2, 0.0f), new Vec2(0.0f, invMass1 + invMass2));
                Mat22 K2 = new Mat22(new Vec2(invI1 * r1.Y * r1.Y, -invI1 * r1.X * r1.Y), new Vec2(-invI1 * r1.X * r1.Y, invI1 * r1.X * r1.X));
                Mat22 K3 = new Mat22(new Vec2(invI2 * r2.Y * r2.Y, -invI2 * r2.X * r2.Y), new Vec2(-invI2 * r2.X * r2.Y, invI2 * r2.X * r2.X));
