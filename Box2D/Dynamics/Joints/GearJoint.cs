...
namespace Box2D
{
    ...
    public class GearJoint : Joint
    {
        ...
        public override float GetReactionTorque(float inv_dt)
        {
            ...
            Vec2 r = MathUtils.Multiply(ref xf1.R, _localAnchor2 - _bodyB.GetLocalCenter());
            Vec2 P = _impulse * _J.linearB;
        ...
        internal override void InitVelocityConstraints(ref TimeStep step)
        {
            ...
            else
            {
                ...
                Vec2 ug = MathUtils.Multiply(ref xfg1.R, _prismatic1._localXAxis1);
                Vec2 r = MathUtils.Multiply(ref xf1.R, _localAnchor1 - b1.GetLocalCenter());
            ...
            else
            {
                ...
                Vec2 ug = MathUtils.Multiply(ref xfg1.R, _prismatic2._localXAxis1);
                Vec2 r = MathUtils.Multiply(ref xf2.R, _localAnchor2 - b2.GetLocalCenter());
                float crug = MathUtils.Cross(r, ug);
        ...
        internal Vec2 _groundAnchor1;
        internal Vec2 _groundAnchor2;
