...
namespace Box2D
{
    ...
    public class Body
    {
        ...
        public void SetTransformIgnoreContacts(Vec2 position, float angle)
        {
            Debug.Assert(_world.IsLocked == false);
            if (_world.IsLocked == true)
            {
        ...
        public void SetLinearVelocity(Vec2 v)
        {
            ...
            _linearVelocity = v;
            Debug.Assert(!(float.IsNaN(_linearVelocity.X) || float.IsNaN(_linearVelocity.Y)), "LinearVelocity is NaN");
        }
        ...
        {
            return _I + _mass * Vec2.Dot(_sweep.localCenter, _sweep.localCenter);
        }
        ...
        public void GetMassData(out MassData massData)
        {
            ...
            massData.mass = _mass;
            massData.I = _I + _mass * Vec2.Dot(_sweep.localCenter, _sweep.localCenter);
