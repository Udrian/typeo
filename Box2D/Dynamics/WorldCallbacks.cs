...
namespace Box2D
{
    ...
    public delegate float RayCastCallback(Fixture fixture, Vec2 point, Vec2 normal, float fraction);
    ...
    public abstract class DebugDraw
    {
        ...
        public abstract void DrawPolygon(ref FixedArray8<Vec2> vertices, int count, Color color);

        /// Draw a solid closed polygon provided in CCW order.
        public abstract void DrawSolidPolygon(ref FixedArray8<Vec2> vertices, int count, Color color);
