...
{
    class Planet : Entity2d, IHasScene<SpaceScene>, IHasData<PlanetData>, IUpdatable, IHasGame<SpaceInvaderGame>
    {
        ...
        {
            Drawable = Drawables.Create(new DrawableTextureOption() { Texture = ContentLoader.LoadContent<Texture>("content/planet.png") });
        ...
        public void Update(double dt)
        {
            ...
            {
                Remove();
                Scene.SpaceSpawnLogic.EntityData.PlanetSpawned = false;
